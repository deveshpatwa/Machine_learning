...
Business Problem: Significant proportion of people are unable to detect the presence of diabetes until it reaches adverse state because of lack of awareness. 
...
3. BMI
4. BP
5 to 10. S1 to s6 are masked because of security reasons
6. Output - 
